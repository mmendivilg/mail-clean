...
- If a required technical prerequisite fails, fix a bounded prerequisite defect when practical. Otherwise record the blocker and continue only independent milestones. Never substitute a stub for a passed dependency.
